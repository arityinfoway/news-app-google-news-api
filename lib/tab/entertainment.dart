...
class _EntertainmentState extends State<Entertainment> {
  ...
  void initState() {
    super.initState();
    if (this.mounted) {
      if (context.read<EntertainmentNewsBlock>().topNews.isEmpty) {
        context.read<EntertainmentNewsBlock>().fetchData(mounted);
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    final cb = context.watch<EntertainmentNewsBlock>();
