...
class SportsNewsBlock extends ChangeNotifier{
  ...
  Future fetchData(mounted) async {
    var response = await http.get(Uri.parse("${Config.baseUrl}/top-headlines?country=in&category=sports&apiKey=${Config.apiKey}"));
    if (mounted) {
      if (response.statusCode == 200) {
        ...
        print("Sports News :"+_topNews[0].content.toString());
