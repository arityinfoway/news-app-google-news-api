...
class WorldNewsBlock extends ChangeNotifier{
  ...
  Future fetchData(mounted) async {
    var response = await http.get(Uri.parse("${Config.baseUrl}/everything?q=world news&sortBy=publishedAt&apiKey=${Config.apiKey}"));
    if (mounted) {
