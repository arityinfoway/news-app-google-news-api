...
class EntertainmentNewsBlock extends ChangeNotifier{
  ...
  Future fetchData(mounted) async {
    var response = await http.get(Uri.parse("${Config.baseUrl}/top-headlines?country=in&category=entertainment&apiKey=${Config.apiKey}"));
    if (mounted) {
